...
class AnnalynsInfiltration
{
    ...
    public function canLiberate(
        ...
        $dog_rescue = $is_dog_present && !$is_archer_awake;
    
        $secret_rescue = !$is_dog_present && $is_prisoner_awake && !$is_knight_awake && !$is_archer_awake;

        return $dog_rescue || $secret_rescue;
    }
}
